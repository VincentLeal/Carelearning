...
const exercise_entity_1 = require("../entity/exercise.entity");
...
let ExerciseController = class ExerciseController {
    ...
    findAll() {
        return __awaiter(this, void 0, void 0, function* () {
            return yield this.exerciseService.findAll();
        });
    }
    findOne(id) {
        return __awaiter(this, void 0, void 0, function* () {
            return yield this.exerciseService.findOne(+id);
        });
    }
    create(exercise) {
        return __awaiter(this, void 0, void 0, function* () {
            const createdExercise = yield this.exerciseService.create(exercise);
            return { exercise: createdExercise };
        });
    }
    update(id, exercise) {
        return __awaiter(this, void 0, void 0, function* () {
            return yield this.exerciseService.update(+id, exercise);
        });
    }
    destroy(id) {
        return __awaiter(this, void 0, void 0, function* () {
            yield this.exerciseService.destroy(+id);
            return;
        });
    }
};
...
__decorate([
    ...
    __metadata("design:paramtypes", [String]),
    __metadata("design:returntype", Promise)
], ExerciseController.prototype, "destroy", null);
