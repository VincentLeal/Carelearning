...
let StudentController = class StudentController {
    ...
    findAll() {
        return __awaiter(this, void 0, void 0, function* () {
            return yield this.studentService.findAll();
        });
    }
    findOne(id) {
        return __awaiter(this, void 0, void 0, function* () {
            return yield this.studentService.findOne(+id);
        });
    }
    create(student) {
        return __awaiter(this, void 0, void 0, function* () {
            const createdStudent = yield this.studentService.create(student);
            return { student: createdStudent };
        });
    }
    update(id, student) {
        return __awaiter(this, void 0, void 0, function* () {
            return yield this.studentService.update(+id, student);
        });
    }
    destroy(id) {
        return __awaiter(this, void 0, void 0, function* () {
            yield this.studentService.destroy(+id);
            return;
        });
    }
};
...
__decorate([
    ...
    __metadata("design:paramtypes", [String]),
    __metadata("design:returntype", Promise)
], StudentController.prototype, "destroy", null);
