...
let LessonController = class LessonController {
    ...
    findAll() {
        return __awaiter(this, void 0, void 0, function* () {
            return yield this.lessonService.findAll();
        });
    }
    findOne(id) {
        return __awaiter(this, void 0, void 0, function* () {
            return yield this.lessonService.findOne(+id);
        });
    }
    create(lesson) {
        return __awaiter(this, void 0, void 0, function* () {
            const createdLesson = yield this.lessonService.create(lesson);
            console.log(lesson);
    ...
    update(id, lesson) {
        return __awaiter(this, void 0, void 0, function* () {
            return yield this.lessonService.update(+id, lesson);
        });
    }
    destroy(id) {
        return __awaiter(this, void 0, void 0, function* () {
            yield this.lessonService.destroy(+id);
            return;
        });
    }
};
...
__decorate([
    ...
    __metadata("design:paramtypes", [String]),
    __metadata("design:returntype", Promise)
], LessonController.prototype, "destroy", null);
