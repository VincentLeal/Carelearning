...
const result_entity_1 = require("../entity/result.entity");
...
let ResultController = class ResultController {
    ...
    findAll() {
        return __awaiter(this, void 0, void 0, function* () {
            return yield this.resultService.findAll();
        });
    }
    findOne(id) {
        return __awaiter(this, void 0, void 0, function* () {
            return yield this.resultService.findOne(+id);
        });
    }
    create(result) {
        return __awaiter(this, void 0, void 0, function* () {
            const createdResult = yield this.resultService.create(result);
            return { result: createdResult };
        });
    }
    update(id, result) {
        return __awaiter(this, void 0, void 0, function* () {
            return yield this.resultService.update(+id, result);
        });
    }
    destroy(id) {
        return __awaiter(this, void 0, void 0, function* () {
            yield this.resultService.destroy(+id);
            return;
        });
    }
};
...
__decorate([
    ...
    __metadata("design:paramtypes", [String]),
    __metadata("design:returntype", Promise)
], ResultController.prototype, "destroy", null);
